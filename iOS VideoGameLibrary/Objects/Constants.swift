...
struct gradientColors {
    ...
    static let red              = UIColor(red: 175.0/255.0, green: 0.0/255.0, blue: 0.0/255.0, alpha: 1.0)
    ...
    static let darkRed          = UIColor(red: 110.0/255.0, green: 24.0/255.0, blue: 24.0/255.0, alpha: 1.0)
    static let brightRed          = UIColor(red: 220.0/255.0, green: 0/255.0, blue: 0/255.0, alpha: 1.0)
